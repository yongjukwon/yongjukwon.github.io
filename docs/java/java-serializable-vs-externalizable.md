...
## 1. What is Serialization
  ...
  <!-- - Serialization is a Java-provided mechan\ism where a object can be represented as a sequence of bytes that includes the object's data as well as information about the object's type and the types of data stored in the object -->
